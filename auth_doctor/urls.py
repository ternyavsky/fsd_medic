...
from .views import DoctorDataPast, DoctorRegSmsCodeSend, IsDoctorVerCodeRight, UpdateDateTimeView
...
urlpatterns = [
    ...
    path('doctor/set_interview_date', UpdateDateTimeView.as_view(), name='doctor_verification_code'),
