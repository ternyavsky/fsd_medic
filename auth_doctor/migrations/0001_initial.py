    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interview_date_plan', models.DateTimeField(null=True, verbose_name='Время, когда пользователь хочет, чтобы было проведено собеседование')),
                ...
                ('clinic', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='api.clinic', verbose_name='Клиника, где врач работает')),
