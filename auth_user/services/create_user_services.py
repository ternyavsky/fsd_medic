...
from auth_user.service import generate_verification_code, send_email, send_sms, send_reset_sms, send_reset_email, set_new_password
...
def verify_reset_code_service(request):
    ...
    if serializer.is_valid():
        ...
        if 'email' in serializer.validated_data:
            ...
            user = User.objects.filter(
                number=serializer.validated_data["number"]).first()
