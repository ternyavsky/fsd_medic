...
def send_reset_sms(number, code):
    ...
    email = os.getenv("EMAIL")
    print(number[1:])
    url = f"https://sms.ru/sms/send?api_id=0F9113E2-B4ED-8975-4BEA-B47ACCC656C6&to={number[1:]}&msg=Вы+пытаетесь+восстановить+доступ+к+аккаунту+,+ваш+код+доступа+-+{code}&json=1"
