    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(max_length=30, unique=True, verbose_name='Номер')),
                ...
                ('center', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='api.center', verbose_name='Центра')),
        ...
        migrations.AddField(
            model_name='user',
            name='centers',
            field=models.ManyToManyField(blank=True, null=True, to='api.center', verbose_name='Центр'),
        ),
        migrations.AddField(
            model_name='user',
            name='country',
