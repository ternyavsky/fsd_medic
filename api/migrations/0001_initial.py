# Generated by Django 4.2.4 on 2023-09-24 10:12
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interest', models.CharField(blank=True, max_length=225, null=True, verbose_name='Интерес к заболеванию')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, null=True, verbose_name='Дата создания')),
                ('updated_at', models.DateTimeField(auto_now=True, null=True, verbose_name='Дата обновления')),
                ('center', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.center', verbose_name='Центр')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='api.group', verbose_name='Группа')),
            ],
            options={
                'verbose_name': 'Ссылку',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employees_number', models.IntegerField(verbose_name='Число Сотрудников')),
                ...
                ('center', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='api.center', verbose_name='Центры')),
                ('country', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='api.country', verbose_name='Страна')),
                ('supported_diseases', models.ManyToManyField(to='api.disease', verbose_name='Поддерживаемые заболевания')),
            ],
            options={
