# Generated by Django 4.2.1 on 2023-07-15 17:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('users_to_note', models.ManyToManyField(blank=True, related_name='users_to_note', to=settings.AUTH_USER_MODEL, verbose_name='Пользователи на запись')),
            ],
            options={
                'verbose_name': 'Запись',
